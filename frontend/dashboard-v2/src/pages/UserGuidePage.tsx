      ...
      <div className="guide-layout">
        ...
        <div className="guide-content">
          <GuideSection id="before" eyebrow="0" title="在你开始之前">
            <p>
              这套系统不是“神奇荐股器”，而是一套本地化的纪律执行工具。它把数据更新、选股、资金约束、风险检查和复盘固定成流程，目标是减少情绪化交易。
            </p>
            ...
            <GuideTable
              ...
              rows={[
                ...
                ["能做", "把“每天判断市场 + 选股 + 守纪律”标准化，目标是年化跑赢核心指数 3-8%"],
          ...
          <GuideSection id="modules" eyebrow="3" title="五个一级模块怎么用">
            <GuideTable
              headers={["模块", "路径", "用途"]}
              rows={[
