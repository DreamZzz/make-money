import { Activity, Beaker, BookOpenText, ClipboardList, Coins, FileText, Gauge, HeartPulse, LayoutDashboard, Trophy } from "lucide-react";

import type { HealthState } from "../types";
import { DataHealthRibbon } from "./DataHealthRibbon";

export type RouteKey = "/today" | "/funds" | "/reports" | "/rebalance" | "/portfolio" | "/market" | "/health" | "/tournament" | "/research" | "/guide";
...
const NAV_ITEMS: Array<{ path: RouteKey; label: string; icon: React.ReactNode }> = [
  ...
  { path: "/reports", label: "财报分析", icon: <FileText size={18} /> },
