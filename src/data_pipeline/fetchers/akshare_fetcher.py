...
def fetch_cn_stock_daily(symbol: str, start_date: str, end_date: str, adjust: str = "qfq") -> pd.DataFrame:
    """
    拉取A股日线数据。
    ...
    try:
        ...
        logger.error(f"Fetch CN daily failed for {symbol}: {e}")
        return pd.DataFrame()


def fetch_hk_stock_daily(symbol: str, start_date: str, end_date: str, adjust: str = "qfq") -> pd.DataFrame:
    """
    拉取港股日线数据。
    symbol: 港股代码，如 "00700"
    """
