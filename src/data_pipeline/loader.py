...
def init_db(conn: duckdb.DuckDBPyConnection) -> None:
    ...
    for col_ddl in [
        ...
        "ALTER TABLE signal_decisions ADD COLUMN IF NOT EXISTS consensus_status VARCHAR",
        "ALTER TABLE signal_decisions ADD COLUMN IF NOT EXISTS arbiter_version VARCHAR DEFAULT 'signal_arbiter_v1'",
        "ALTER TABLE signal_decisions ADD COLUMN IF NOT EXISTS qlib_prediction_date DATE",
        "ALTER TABLE signal_decisions ADD COLUMN IF NOT EXISTS qlib_rank INTEGER",
        "ALTER TABLE signal_decisions ADD COLUMN IF NOT EXISTS qlib_confidence DOUBLE",
        "ALTER TABLE signal_decisions ADD COLUMN IF NOT EXISTS priority_score DOUBLE",
        "ALTER TABLE signal_decisions ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP",
        ...
        "ALTER TABLE allocation_plans ADD COLUMN IF NOT EXISTS cash_target_pct DOUBLE DEFAULT 0",
